...
- **`view_items_in_registries` returns no file contents**, only name, type, file count and dependencies. When you need the actual markup or prop usage, go to `get_item_examples_from_registries`.
