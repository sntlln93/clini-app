...
test.describe('authenticated views', () => {
  ...
  test('/ (dashboard) has no unexpected accessibility violations', async ({ page }) => {
    await page.goto('/')
    await page.waitForLoadState('networkidle')
  ...
  test('/agenda has no unexpected accessibility violations', async ({ page }) => {
  ...
  test('/pacientes has no unexpected accessibility violations', async ({ page }) => {
  ...
  test('/profesionales has no unexpected accessibility violations', async ({ page }) => {
  ...
  test('/disponibilidad has no unexpected accessibility violations', async ({ page }) => {
  ...
  test('/ajustes has no unexpected accessibility violations', async ({ page }) => {
  ...
  test('the "Nuevo turno" appointment form dialog has no unexpected accessibility violations', async ({
    ...
    await expect(page.getByRole('dialog', { name: 'Nuevo turno' })).toBeVisible()
